...
import { linearScale, invertLinearScale } from '../src/linear-scale';
...
test('invert linear scale returns correct value with specified width', t => {
  const ls = invertLinearScale(0, 100, 1000);
